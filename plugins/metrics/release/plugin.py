...
"""Release metrics plugin for OSCAR."""

from plugins.base_plugin import LambdaConfig, OscarPlugin
from plugins.metrics.iam_policies import get_policies
from plugins.metrics.release.action_groups import get_action_groups
from plugins.metrics.release.instructions import (AGENT_INSTRUCTION,
                                                  COLLABORATOR_INSTRUCTION)


class MetricsReleasePlugin(OscarPlugin):
    ...
    def get_collaborator_name(self):
        return "Release-Readiness-Metrics-Specialist"
