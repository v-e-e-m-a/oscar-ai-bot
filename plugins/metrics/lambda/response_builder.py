...
def create_response(event: Dict[str, Any], result: Dict[str, Any]) -> Dict[str, Any]:
    ...
    logger.info("CREATE_RESPONSE: Starting response creation")
    ...
    logger.info("CREATE_RESPONSE: About to serialize result to JSON")
    ...
    logger.info("CREATE_RESPONSE: Response creation complete")
